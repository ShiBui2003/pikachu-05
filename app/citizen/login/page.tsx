        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/citizen/signup" className="text-accent hover:underline">
                Sign up
              </Link>
            </div>

            <div className="text-center">
              <Link href="/citizen/forgot-password" className="text-sm text-muted-foreground hover:text-accent">
