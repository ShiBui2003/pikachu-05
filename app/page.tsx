import { MapPin, Shield, Zap, Users, TrendingUp, Check, Download, LogIn, Globe, Lock, ArrowRight, Star, Bell, BarChart3, Smartphone } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold text-[#2E6A56]">JANMARG</span>
            </div>
              ...
              <div className="bg-white/95 backdrop-blur-sm shadow-xl border-0 hover:shadow-2xl transition-all duration-500 hover:scale-105 rounded-lg">
                ...
                <div className="space-y-3 p-6">
                  <div className="flex items-center space-x-3 p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                    ...
                    <span className="text-sm font-medium text-emerald-800">Report civic issues instantly</span>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                    ...
                    <span className="text-sm font-medium text-blue-800">Track resolution progress</span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#2E6A56]/20 transition-all duration-300 hover:scale-105 group rounded-lg p-6">
                <div className="pb-4">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xl font-bold">JANMARG</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Link href="/auth?mode=signup" className="block text-gray-400 hover:text-white transition-colors">
                  Get Started
                </Link>
                <Link href="/auth?mode=login" className="block text-gray-400 hover:text-white transition-colors">
                  Admin Portal
                </Link>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>© 2025 Janmarg. All rights reserved. | A Digital India Initiative</p>
          </div>
        </div>
      </footer>
    </div>
