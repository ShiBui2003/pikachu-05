...
export async function PUT(
  ...
  try {
    ...
    try {
      const departmentName = typeof updatedIssue.department === 'object' && updatedIssue.department 
    ...
    try {
      await supabase
        ...
        .insert({
          ...
          details: { department_id, department_name: updatedIssue.department?.name },
          created_at: new Date().toISOString()
        });
    ...
    console.error('Error in PUT /api/issues/[id]/assign-department:', error);
